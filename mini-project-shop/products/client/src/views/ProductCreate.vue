        ...
        <div class="col-md-9">
          <div class="row">
            <div class="col-auto">
              ...
              >
                <option :value="cate" v-for="(cate, i) in category1" :key="i">
                  {{ cate }}
                </option>
              </select>
            </div>
            <div class="col-auto">
              ...
              >
                <option :value="cate" v-for="(cate, i) in category2" :key="i">
                  {{ cate }}
                </option>
              </select>
            </div>
            <div class="col-auto">
              <select class="form-select" v-model="cate3">
                <option :value="cate" v-for="(cate, i) in category3" :key="i">
                  {{ cate }}
                </option>
              </select>
            </div>
...
export default {
  ...
  methods: {
    ...
    productInsert() {
      ...
      if (
        this.product.add_delivery_price === '' ||
        this.product.add_delivery_price === 0
      ) {
        return this.$swal('추가배송비를 입력하세요.')
      }
      if (
